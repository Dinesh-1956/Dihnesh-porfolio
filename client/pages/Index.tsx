    ...
    <Layout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 w-full z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center min-h-auto lg:min-h-[600px]">
            {/* Left: Profile Image */}
            <Parallax offset={0.4}>
              <div
              ...
              >
                <div className="relative w-48 h-48 xs:w-56 xs:h-56 sm:w-72 sm:h-72 md:w-96 md:h-96">
            ...
            >
              <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                ...
                <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                  <p className="text-xs sm:text-base text-slate-700 tracking-wide">
                    Digital Electronics • VLSI • Hardware Design
                  </p>
                  <p className="text-sm sm:text-lg text-slate-600 leading-relaxed font-light max-w-lg">
                ...
                {/* CTA Buttons */}
                <div className="flex flex-wrap gap-2 sm:gap-3 pt-4 sm:pt-6 lg:pt-8">
                  <Link
                    to="/resume"
                    className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full flex items-center justify-center font-light text-xs sm:text-sm text-gray-900 hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-2 active:scale-95"
                  ...
                  <Link
                    to="/projects"
                    className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full flex items-center justify-center font-light text-xs sm:text-sm text-white hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-2 active:scale-95"
      ...
      {/* About Section */}
      <section className="py-16 sm:py-24 lg:py-32 xl:py-48 bg-white relative overflow-hidden">
        <div className="absolute -top-40 right-0 w-64 sm:w-80 h-64 sm:h-80 bg-slate-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30" />

        <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
          <ScrollReveal direction="up" delay={0}>
            <div className="space-y-8">
              <div className="inline-block">
                <p className="text-xs font-semibold text-slate-500 tracking-widest uppercase opacity-70">
                  About
                </p>
              </div>
              <h2 className="font-light text-3xl sm:text-5xl lg:text-6xl xl:text-7xl text-slate-900 leading-tight tracking-tight">
          ...
          <ScrollReveal direction="up" delay={150}>
            <div className="mt-8 sm:mt-12 lg:mt-16 space-y-4 sm:space-y-6 max-w-3xl">
      ...
      {/* Skills Section */}
      <section className="py-16 sm:py-24 lg:py-32 xl:py-48 bg-slate-50 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-64 sm:w-80 h-64 sm:h-80 bg-slate-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
          <ScrollReveal direction="up" delay={0}>
            <div className="space-y-2 sm:space-y-4">
              ...
              <p className="text-sm sm:text-lg text-slate-600 mt-4 sm:mt-6 font-light max-w-2xl">
