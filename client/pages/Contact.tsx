        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="p-8 bg-gray-50 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <a href="mailto:contact@mohammedshahzaman.dev" className="text-brand-yellow font-semibold hover:underline">
                contact@mohammedshahzaman.dev
              </a>
            </div>
            ...
            <div className="p-8 bg-gray-50 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 mb-2">Available for calls and consultations</p>
          ...
          <div className="mt-16 p-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200 text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-3">Let's Collaborate</h3>
            <p className="text-gray-700 mb-6">
              Whether you're looking to build a new product, optimize existing systems, or explore AI-driven solutions, I'm excited to help bring your ideas to life. Let's discuss how I can contribute to your project.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="mailto:contact@mohammedshahzaman.dev"
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600">
              💬 I typically respond to messages within <span className="font-semibold">24-48 hours</span>
            </p>
          </div>
        </div>
      </div>
